...
const SignUpPage = () => {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      const registerResponse = await axios.post('https://185.49.165.101:5002/api/Auth/register', {
      ...
      await axios.post(
        `https://185.49.165.101:5002/api/Auth/send-otp?key=${encodeURIComponent(keyFromBackend)}`
      );
